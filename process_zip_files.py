            ...
            with zipfile.ZipFile(io.BytesIO(zip_content), 'r') as zip_ref:
                ...
                with zip_ref.open(csv_file_name) as csv_file:
                    ...
                    if csv_header == schema_header:
                        ...
                        destination_blob_zip = bucket.blob(zip_blob.name.replace(landing_folder, zip_folder, 1))
                        destination_blob_zip.copy_from(zip_blob)
                        zip_blob.delete()
                        ...
                        destination_blob_zip_b = bucket.blob(zip_blob.name.replace(landing_folder, error_folder, 1))
                        destination_blob_zip_b.copy_from(zip_blob)
                        zip_blob.delete()
